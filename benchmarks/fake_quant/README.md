...
```bash
cd benchmarks
DATA_DIR=../data/onerec_data/benchmark-data bash fake_quant/run_hf_ad_full_quant.sh
```
...
```bash
cd benchmarks
DATA_DIR=../data/onerec_data/benchmark-data bash fake_quant/run_layer_sensitivity.sh
```
...
```bash
cd benchmarks
DATA_DIR=../data/onerec_data/benchmark-data bash fake_quant/smoothquant/run_smoothquant_ad.sh
```
