...
DEVICE="${DEVICE:-cuda}"
SEED="${SEED:-42}"
OUTPUT_DIR="${OUTPUT_DIR:-fake_quant/probes/activation_probe/activation_profiles/${VERSION}/channel_overlap_sample_${SAMPLE_INDEX}}"
...
python fake_quant/probes/activation_probe/analyze_channel_overlap.py \
