...
OUTPUT_DIR="${OUTPUT_DIR:-${BASE_OUTPUT_ROOT}/results_OneRec-1.7B-hf-fake-fp8-ranking-margin-smoothquant-b${SMOOTH_IMPORTANCE_BETA}-calib${CALIB_SAMPLE_SIZE}-imp${IMPORTANCE_SAMPLE_SIZE}-offset${IMPORTANCE_SAMPLE_OFFSET}-ad-${SAMPLE_SIZE}}"
MODEL_NAME="${MODEL_NAME:-OneRec-1.7B-hf-fake-fp8-ranking-margin-smoothquant-b${SMOOTH_IMPORTANCE_BETA}-calib${CALIB_SAMPLE_SIZE}-imp${IMPORTANCE_SAMPLE_SIZE}-offset${IMPORTANCE_SAMPLE_OFFSET}}"
